...
public class SetupActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        UserName = (EditText) findViewById(R.id.nav_user_full_name);
        FullName = (EditText) findViewById(R.id.fullname);
        CountryName = (EditText) findViewById(R.id.country);
        SaveInformationbuttion = (Button) findViewById(R.id.button);
        ProfileImage = (ImageView) findViewById(R.id.displaypic);
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    if (dataSnapshot.hasChild("profileimage"))
                    {
                        ...
                        Picasso.get().load(image).placeholder(R.drawable.dp).into(ProfileImage);
                    }
                    else
                    {
